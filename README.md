...
La prima schermata è HomeScreen da cui si può effettuare il Login (LoginScreen) o Registrarsi (RegisterScreen)
Dalla schermata di Login è possibile richiedere una nuova password tramite il ForgotPasswordScreen
Dopo il processo di Login o Registrazione si passa alla Dashboard.
