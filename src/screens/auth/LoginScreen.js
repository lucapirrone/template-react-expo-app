...
const LoginScreen = ({ navigation }) => {
  ...
  const _onLoginPressed = () => {
    ...
    onLogIn(email.value, password.value, err=>{
      if (err) {
  ...
  return (
    <Background>
      ...
      <View style={styles.forgotPassword}>
        ...
        >
          <Text style={styles.label}>Hai dimenticato la password?</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.row}>
        <Text style={styles.label}>Non hai ancora un account? </Text>
